...
checkpointer = tf.keras.callbacks.ModelCheckpoint('Xception_model.h5', verbose=1, save_best_only=True)
callbacks = [
...
train_pred_proba = predict_model(xception_model, train_generator, steps=train_steps)
val_pred_proba = predict_model(xception_model, validation_generator, steps=val_steps)
