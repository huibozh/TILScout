...
######### prediction
"""
vgg19_model=keras.models.load_model('vgg19_model.h5')
...
train_pred_proba = predict_model(vgg19_model, train_generator, steps=train_steps)
val_pred_proba = predict_model(vgg19_model, validation_generator, steps=val_steps)
