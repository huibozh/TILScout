...
checkpointer = tf.keras.callbacks.ModelCheckpoint('vgg16_model.h5', verbose=1, save_best_only=True)
callbacks = [
...
train_pred_proba = predict_model(vgg16_model, train_generator, steps=train_steps)
val_pred_proba = predict_model(vgg16_model, validation_generator, steps=val_steps)
